 ...
 */
BOOST_AUTO_TEST_CASE(basic_constructor_case)
{
 ...
 */
BOOST_AUTO_TEST_CASE(init_buffer_size_constructor_case)
{
 ...
 */
BOOST_AUTO_TEST_CASE(assignment_operator_case)
{
	size_t testSize = 67;
...
/**
 * \test Buffer expansion method and size getter method test case.
 *
 * Pass requirements:
 ...
 * 	  the actual one.
 */
BOOST_AUTO_TEST_CASE(buffer_expension_size_getter_methods_case)
{
 ...
 */
BOOST_AUTO_TEST_CASE(meesage_number_getter_case)
{
 ...
 */
BOOST_AUTO_TEST_CASE(push_method_case)
{
 ...
 */
BOOST_AUTO_TEST_CASE(isEmpty_isFull_clear_methods_case)
{
	const size_t testSize = 10;
	DebugLogBase testObject(testSize);
	char testChar;
